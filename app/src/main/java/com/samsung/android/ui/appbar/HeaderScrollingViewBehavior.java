...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public void layoutChild(SeslCoordinatorLayout var1, View var2, int var3) {
    ...
    public boolean onMeasureChild(SeslCoordinatorLayout var1, View var2, int var3, int var4, int var5, int var6) {
