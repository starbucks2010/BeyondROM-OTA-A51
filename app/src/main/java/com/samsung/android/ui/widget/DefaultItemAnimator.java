...
import com.samsung.android.ui.widget.SeslRecyclerView.ViewHolder;
...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        if (getHostView() instanceof SeslRecyclerView) {
            final SeslRecyclerView recyclerView = (SeslRecyclerView) getHostView();
