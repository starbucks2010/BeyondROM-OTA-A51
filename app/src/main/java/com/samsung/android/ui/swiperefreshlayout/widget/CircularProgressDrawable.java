...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static final int[] COLORS = new int[]{Color.parseColor("#008cff"), Color.parseColor("#06b485")};
    ...
    static final Interpolator SINE_IN_80_INTERPOLATOR = new PathInterpolator(0.8F, 0.0F, 0.83F, 0.83F);
    static final Interpolator SINE_IN_OUT_33_INTERPOLATOR = new PathInterpolator(0.33F, 0.0F, 0.67F, 1.0F);
    static final Interpolator SINE_IN_OUT_80_INTERPOLATOR = new PathInterpolator(0.33F, 0.0F, 0.2F, 1.0F);
    static final Interpolator SINE_OUT_60_INTERPOLATOR = new PathInterpolator(0.17F, 0.17F, 0.4F, 1.0F);
    private static final float STROKE_WIDTH = 2.5F;
    private static final float STROKE_WIDTH_LARGE = 3.0F;
    private CircularProgressDrawable.OnAnimationEndCallback mAnimationEndCallback = null;
    ...
    public CircularProgressDrawable(@NonNull Context var1) {
    ...
    private void applyFinishTranslation(float var1, CircularProgressDrawable.Ring var2) {
        ...
        if (var1 <= 0.2F) {
            var3 = var1 / 0.2F;
            var2.setArrowScale(1.0F - SINE_IN_OUT_33_INTERPOLATOR.getInterpolation(var3));
        }

        var3 = (float)(Math.floor((double)(var2.getStartingRotation() / 0.8F)) + 1.0D);
        var2.setStartTrim(var2.getStartingStartTrim() + (var2.getStartingEndTrim() - 0.01F - var2.getStartingStartTrim()) * SINE_OUT_60_INTERPOLATOR.getInterpolation(var1));
        var2.setEndTrim(var2.getStartingEndTrim());
        var2.setRotation(var2.getStartingRotation() + (var3 - var2.getStartingRotation()) * SINE_OUT_60_INTERPOLATOR.getInterpolation(var1));
        if (SINE_OUT_60_INTERPOLATOR.getInterpolation(var1) > 0.7F) {
            CircularProgressDrawable.OnAnimationEndCallback var4 = this.mAnimationEndCallback;
            if (var4 != null && !this.mEnding) {
                var4.OnAnimationEnd();
                this.mEnding = true;
            }
        }
    ...
    void applyTransformation(float var1, CircularProgressDrawable.Ring var2, boolean var3) {
        if (this.mFinishing) {
            ...
            if (var1 <= 0.4F) {
                ...
                var5 = SINE_IN_OUT_80_INTERPOLATOR.getInterpolation(var5) * 0.79F + 0.01F + var6;
            } else {
                var6 = (var1 - 0.4F) / 0.6F;
                var5 = var2.getStartingStartTrim() + 0.79F;
                var6 = var5 - ((1.0F - SINE_IN_OUT_80_INTERPOLATOR.getInterpolation(var6)) * 0.79F + 0.01F);
            }

            float var7 = SINE_IN_OUT_33_INTERPOLATOR.getInterpolation(var1);
            float var8 = this.mRotationCount;
            var2.setStartTrim(var6);
            var2.setEndTrim(var5);
            var2.setRotation(var4 + var7 * 0.25F);
            this.setRotation((var1 + var8) * 216.0F);
        }
    ...
    public void setColorSchemeColors(@NonNull int... var1) {
        this.mRing.setColors(var1);
        this.mRing.setColorIndex(0);
        this.invalidateSelf();
    }

    public void setOnAnimationEndCallback(@Nullable CircularProgressDrawable.OnAnimationEndCallback var1) {
        this.mAnimationEndCallback = var1;
    }
    ...
    public void setStrokeCap(@NonNull Cap var1) {
    ...
    public void start() {
        ...
        if (this.mRing.getEndTrim() != this.mRing.getStartTrim()) {
            ...
            if (this.mAnimationEndCallback != null) {
                ((ValueAnimator)this.mAnimator).setRepeatCount(0);
            } else {
                ((ValueAnimator)this.mAnimator).setRepeatCount(-1);
            }
            ...
            this.mAnimator.setDuration(1683L);
            this.mAnimator.start();
        }
