...
import androidx.appcompat.widget.AppCompatBackgroundHelper2;
...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private final AppCompatBackgroundHelper2 mBackgroundTintHelper;
    ...
    public AppCompatSpinner(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        mBackgroundTintHelper = new AppCompatBackgroundHelper2(this);
    ...
    public Parcelable onSaveInstanceState() {
        final AppCompatSpinner.SavedState ss = new AppCompatSpinner.SavedState(super.onSaveInstanceState());
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                    ...
                    if (getOnItemClickListener() != null) {
                        AppCompatSpinner.this.performItemClick(v, position, mAdapter.getItemId(position));
                    }
                    dismiss();
                }
            });
        ...
        void computeContentWidth() {
            ...
            if (background != null) {
                background.getPadding(mTempRect);
                hOffset = ViewUtils.isLayoutRtl(AppCompatSpinner.this) ? mTempRect.right : -mTempRect.left;
            } else {
