...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final int scroll(SeslCoordinatorLayout var1, V var2, int var3, int var4, int var5) {
        return this.setHeaderTopBottomOffset(var1, var2, this.getTopBottomOffsetForScrollingSibling() - var3, var4, var5);
    }

    public int setHeaderTopBottomOffset(SeslCoordinatorLayout var1, V var2, int var3) {
        return this.setHeaderTopBottomOffset(var1, var2, var3, -2147483648, 2147483647);
    }

    public abstract int setHeaderTopBottomOffset(SeslCoordinatorLayout var1, V var2, int var3, int var4, int var5);
}
