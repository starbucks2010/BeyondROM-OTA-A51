...
public class AppReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(Constants.INTENT_MANIFEST_CHECK_BACKGROUND)) {
            ...
            GeneralUtils.dismissNotifications(context);
            if (updateAvailable) {
        ...
        if (action.equals(Constants.INTENT_START_UPDATE_CHECK)) {
        ...
        if (action.equals(Intent.ACTION_BOOT_COMPLETED) || action.equals("android.intent.action.QUICKBOOT_POWERON")) {
            ...
            if (rebootForInstall) {
                ...
                GeneralUtils.setupDownloadInstallNotification(context, !updateFile.exists());
                updateFile.delete();
